 ...
 */
public class LatifiCropImageOptions implements Parcelable {

    public static final Creator<LatifiCropImageOptions> CREATOR =
            new Creator<LatifiCropImageOptions>() {
                @Override
                public LatifiCropImageOptions createFromParcel(Parcel in) {
                    return new LatifiCropImageOptions(in);
                }

                @Override
                public LatifiCropImageOptions[] newArray(int size) {
                    return new LatifiCropImageOptions[size];
                }
            };

    /** The shape of the cropping window. */
    public LatifiCropImageView.CropShape cropShape;
    ...
    public LatifiCropImageView.Guidelines guidelines;

    /** The initial scale type of the image in the crop image view */
    public LatifiCropImageView.ScaleType scaleType;
    ...
    public LatifiCropImageView.RequestSizeOptions outputRequestSizeOptions;
    ...
    public LatifiCropImageOptions() {

        DisplayMetrics dm = Resources.getSystem().getDisplayMetrics();

        cropShape = LatifiCropImageView.CropShape.RECTANGLE;
        ...
        guidelines = LatifiCropImageView.Guidelines.ON_TOUCH;
        scaleType = LatifiCropImageView.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = LatifiCropImageView.RequestSizeOptions.NONE;
        noOutputImage = false;
    ...
    protected LatifiCropImageOptions(Parcel in) {
        cropShape = LatifiCropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = LatifiCropImageView.Guidelines.values()[in.readInt()];
        scaleType = LatifiCropImageView.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = LatifiCropImageView.RequestSizeOptions.values()[in.readInt()];
