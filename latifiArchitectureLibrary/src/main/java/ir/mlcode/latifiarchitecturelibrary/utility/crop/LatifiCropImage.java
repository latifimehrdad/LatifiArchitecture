...
public final class LatifiCropImage {
    ...
    public static final class ActivityBuilder {
        ...
        private final LatifiCropImageOptions mOptions;

        private ActivityBuilder(@Nullable Uri source) {
            mSource = source;
            mOptions = new LatifiCropImageOptions();
        }
...
/*        public Intent getIntent(@NonNull Context context) {
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            ...
            intent.putExtra(LatifiCropImage.CROP_IMAGE_EXTRA_BUNDLE, bundle);
            return intent;
        }
...
/*        @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
         ...
         */
        public ActivityBuilder setCropShape(@NonNull LatifiCropImageView.CropShape cropShape) {
         ...
         */
        public ActivityBuilder setGuidelines(@NonNull LatifiCropImageView.Guidelines guidelines) {
         ...
         */
        public ActivityBuilder setScaleType(@NonNull LatifiCropImageView.ScaleType scaleType) {
         ...
         * Uses {@link LatifiCropImageView.RequestSizeOptions#RESIZE_INSIDE} option.<br>
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
            return setRequestedSize(reqWidth, reqHeight, LatifiCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
        ...
        public ActivityBuilder setRequestedSize(
                int reqWidth, int reqHeight, LatifiCropImageView.RequestSizeOptions options) {
    ...
    public static final class ActivityResult extends LatifiCropImageView.CropResult implements Parcelable {
