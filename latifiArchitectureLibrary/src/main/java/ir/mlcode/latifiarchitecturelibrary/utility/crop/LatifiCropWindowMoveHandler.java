 ...
 * <br>
 */
final class LatifiCropWindowMoveHandler {
    ...
    /**
     * @param latifiCropWindowHandler main crop window handle to get and update the crop window edges
     ...
     */
    public LatifiCropWindowMoveHandler(
            Type type, LatifiCropWindowHandler latifiCropWindowHandler, float touchX, float touchY) {
        mType = type;
        mMinCropWidth = latifiCropWindowHandler.getMinCropWidth();
        mMinCropHeight = latifiCropWindowHandler.getMinCropHeight();
        mMaxCropWidth = latifiCropWindowHandler.getMaxCropWidth();
        mMaxCropHeight = latifiCropWindowHandler.getMaxCropHeight();
        calculateTouchOffset(latifiCropWindowHandler.getRect(), touchX, touchY);
    }
